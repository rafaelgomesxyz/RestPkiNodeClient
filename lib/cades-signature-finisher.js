   ...
   async finish() {
      ...
      try{
         ...
         if(apiVersion >= 2){
            ...
            let response = await this._client.getRestClient().post(`Api/v2/CadesSignatures/${this._token}/SignedBytes`, request).data;
         ...
         if (!this._signature) {
            let response = await this._client.getRestClient().post(`Api/CadesSignatures/${this._token}/Finalize`).data;
            ...
            let response = await this._client.getRestClient().post(`Api/CadesSignatures/${this._token}/SignedBytes`, request).data;
